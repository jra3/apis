module github.com/antimetal/apis
...
require (
	...
	istio.io/tools v0.0.0-20250124091001-cc603b090478
)

require google.golang.org/protobuf v1.36.4-0.20250116160514-2005adbe0cf6
