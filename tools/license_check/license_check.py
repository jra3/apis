...
parser = argparse.ArgumentParser(description="Check that license header is included in Protobuf files.")
parser.add_argument(
    "-v", "--verbose",
...
parser.add_argument(
  ...
  nargs="?",
  default=os.getcwd(),
  help="Path to walk for license check (default: current directory)",
)

args = parser.parse_args()

# Define the header you want to check for and insert
header = """// Antimetal API definitions
